...
#Show UI flag for user info
	echo "The pruning function has already been enabled and cannot be run again with this command. Please consult the manual for more info" > /var/www/html/prune-text.txt
